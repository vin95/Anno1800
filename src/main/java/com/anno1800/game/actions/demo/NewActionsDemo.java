...
import com.anno1800.game.actions.actions.SwapResidentCards;
import com.anno1800.game.actions.actions.UpgradeResident;
...
public class NewActionsDemo {
    ...
    private static void demonstrateSwapResidentCards(Player player, Board board) {
        ...
        SwapResidentCards.swapResidentCards(player, swapAction.cardsToSwap());
    ...
    private static void demonstrateUpgradeResident(Player player, Board board) {
        ...
        if (residentCounts[1] > 0) {
            ...
            try {
                UpgradeResident.upgradeResident(player, upgradeAction.amount(), upgradeAction.residentLevel());
