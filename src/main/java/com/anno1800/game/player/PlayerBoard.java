...
public class PlayerBoard {
    ...
    /**
     * Adds a factory instance to the player board.
     ...
     * @param ship The ship instance to add (ExplorerShip or TradeShip)
     ...
     */
    public void addShip(Object ship, ShipType shipType, int level) {
        ...
        switch (shipType) {
            case ExplorerShip -> {
                if (ship instanceof com.anno1800.game.tiles.ExplorerShip explorerShip) {
                    ...
                    throw new IllegalArgumentException("Expected ExplorerShip but got " + ship.getClass().getSimpleName());
                }
            }
            case TradeShip -> {
